...
resource "aws_s3_bucket" "example" {
  bucket = "abdulrazigtestbycketterra7788abcdededded0oradam00"

  tags = {
    Name        = "abdulrazigtestbycketterra7788abcdededded0oradam00"
    Environment = "Dev"
  }
}
...
name = "devopswithawsbyAbdulrazig"
}
